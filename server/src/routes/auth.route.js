...
const { registerController, loginController, logoutController, updateProfileController, profileUserController, loginExtensionController } = require("../controllers/auth.controllers.js");
